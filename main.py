...
parser.add_argument('--maxlen', default=config.maxlen, type=int)
...
parser.add_argument('--l2_emb', default=config.l2_emb, type=float)
...
if __name__ == '__main__':
    ...
    if args.inference_only:
        ...
        print('test (NDCG@100: %.4f, HR@100: %.4f)' % (t_test[0], t_test[1]))
